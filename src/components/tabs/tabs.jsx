const DETAIL_INFO = [`Overview`, `Details`, `Reviews`];
...
export default class Tabs extends React.PureComponent {
  ...
  render() {
    const {onDataChange, isActive} = this.props;
      ...
      <>
        <nav className="movie-nav movie-card__nav">
          <ul className="movie-nav__list">
            <li
              className={isActive === `Overview` ? `movie-nav__item movie-nav__item--active` :
                `movie-nav__item`} onClick={onDataChange}>
              <a href="#" className="movie-nav__link">Overview</a>
            </li>
            <li className={isActive === `Details` ? `movie-nav__item movie-nav__item--active` :
              `movie-nav__item`} onClick={onDataChange}>
              <a href="#" className="movie-nav__link">Details</a>
            </li>
            <li className={isActive === `Reviews` ? `movie-nav__item movie-nav__item--active` :
              `movie-nav__item`} onClick={onDataChange}>
